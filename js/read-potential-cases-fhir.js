...
(async () => {
  ...
  await fs.writeFile("death-by-diseases-of-the-eye-and-adnexa-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("death-by-diseases-of-the-eye-and-adnexa-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
